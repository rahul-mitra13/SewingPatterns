...
int main(int argc, char **argv) {
  ...
  //                               "viewMat":[-0.625171661376953,-3.25962901115417e-09,0.780487358570099,
  //                               1.15412271022797,0.140835881233215,0.983585238456726,
  //                               0.112809918820858,-0.683530271053314,-0.767675340175629,
  //                               0.180446282029152,-0.614909410476685,-29.2807006835938,0.0,0.0,0.0,1.0],
  //                               "windowHeight":975,
  //                               "windowWidth":1728})";
